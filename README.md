...
| [**problem-radar**](https://github.com/DataVantage/AI_Problem_Radar) | *"Which concrete, budgeted business problem is worth starting with?"* Collects public signals, deduplicates, clusters and scores them — every score explainable down to the sentence that produced it. | Python (standard library only) · TF-IDF · SQLite |
